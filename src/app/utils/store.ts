...
const defaultTestimonials: Testimonial[] = [
  { id: 't1', name: 'Deepak Srivastava', designation: 'Independent Director', organization: 'A Renowned Energy Conglomerate', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&auto=format', text: 'BoardOpp is not a platform — it is a governance movement. It has fundamentally changed how India\'s most accomplished professionals think about board service.', order: 1, active: true },
  ...
  { id: 't3', name: 'Rajan Pillai', designation: 'Former CMD', organization: 'Renowned Public Sector Bank', photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&auto=format', text: 'The Director Readiness Assessment gave me a clear-eyed view of where I stood and what I needed to develop before taking on an independent director role. Invaluable.', order: 3, active: true },
];
